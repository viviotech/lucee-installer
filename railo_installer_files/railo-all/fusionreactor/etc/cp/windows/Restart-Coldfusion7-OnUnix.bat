...
REM FusionReactor to automatically restart a ColdFusion MX 7 server running on a remote Unix
...
REM -------------------------------------------------------------------------------------------
set LOGFILE=C:\FusionReactor\etc\cp\Restart-Coldfusion7-OnUnix.log
REM -------------------------------------------------------------------------------------------
...
REM -------------------------------------------------------------------------------------------
set COMMAND=/opt/coldfusionmx7/bin/coldfusion start
REM -------------------------------------------------------------------------------------------
