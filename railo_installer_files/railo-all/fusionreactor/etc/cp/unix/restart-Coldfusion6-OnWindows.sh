...
# FusionReactor to automatically restart a ColdFusion MX server running on a remote Windows
# machine from Unix.
#
...
# -------------------------------------------------------------------------------------------
LOGFILE=/opt/fusionreactor/etc/cp/restart-Coldfusion6-OnWindows.log
# -------------------------------------------------------------------------------------------
...
# -------------------------------------------------------------------------------------------
COMMAND=net start "ColdFusion MX Application Server"
# -------------------------------------------------------------------------------------------
