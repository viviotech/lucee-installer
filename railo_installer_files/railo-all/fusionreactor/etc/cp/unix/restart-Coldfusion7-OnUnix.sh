...
# FusionReactor to automatically restart a ColdFusion MX 7 server running on a remote Unix
# machine from Unix.
#
...
# -------------------------------------------------------------------------------------------
LOGFILE=/opt/fusionreactor/etc/cp/restart-Coldfusion7-OnUnix.log
# -------------------------------------------------------------------------------------------
...
# -------------------------------------------------------------------------------------------
COMMAND="/opt/coldfusionmx7/bin/coldfusion start"
# -------------------------------------------------------------------------------------------
