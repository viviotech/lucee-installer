...
# FusionReactor to automatically restart a ColdFusion 9 server running on a remote Windows
# machine from Unix.
#
...
# -------------------------------------------------------------------------------------------
LOGFILE=/opt/fusionreactor/etc/cp/restart-Coldfusion9-OnWindows.log
# -------------------------------------------------------------------------------------------
...
# -------------------------------------------------------------------------------------------
COMMAND=net start "ColdFusion 9 Application Server"
# -------------------------------------------------------------------------------------------
