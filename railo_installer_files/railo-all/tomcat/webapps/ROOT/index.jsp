...
request.setAttribute("tomcat7DocUrl", "/tomcat-docs/");
    ...
    <body>
        <div id="wrapper">
            <div id="navigation" class="curved container">
                ...
                <span id="nav-hosts"><a href="${tomcat7DocUrl}/index.html">Documentation</a></span>
            ...
            <div id="upper" class="curved container">
                ...
                <div id="actions">
                    <div class="button">
                        <a class="container shadow" href="/tomcat-manager/status"><span>Server Status</span></a>
                    </div>
                    <div class="button">
            ...
            <div id="lower">
                <div id="low-manage" class="">
                    <div class="curved container">
                        ...
                        <p>For security, access to the <a href="/tomcat-manager/html">manager webapp</a> is restricted.
                ...
                <div id="low-docs" class="">
                    <div class="curved container">
                        <h3>Documentation</h3>
                        <h4><a href="${tomcat7DocUrl}/index.html">Tomcat 7.0 Documentation</a></h4>
