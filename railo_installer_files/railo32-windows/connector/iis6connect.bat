...
rem ----------------------------------------------------------------------------------------------------
cscript.exe @@installdir@@\connector\iis6isapifilter.js -site:W3SVC -name:CFML -action:add -dll:@@installdir@@\connector\isapi_redirect-1.2.31.dll
cscript.exe C:\WINDOWS\system32\iisext.vbs /AddFile @@installdir@@\connector\isapi_redirect-1.2.31.dll 1 CFML 1 CFML
...
cscript.exe @@installdir@@\connector\chglist.vbs W3SVC/ScriptMaps "" ".cfm,@@installdir@@\connector\isapi_redirect-1.2.31.dll,5,GET,HEAD,POST,TRACE" /INSERT /COMMIT
