...
rem ----------------------------------------------------------------------------------------------------
%windir%\system32\inetsrv\appcmd.exe set config -section:system.webServer/security/isapiCgiRestriction /+"[path='@@installdir@@\connector\isapi_redirect-1.2.30.dll',allowed='True',description='Railo-Tomcat Extension']" /commit:apphost
%windir%\system32\inetsrv\appcmd.exe set config -section:isapiFilters /+[name='Railo',path='@@installdir@@\connector\isapi_redirect-1.2.30.dll']
