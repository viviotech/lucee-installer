...
rem
rem  This is a modified version of the original meant for installation of Railo service
rem  it is not recommended for generic use (Bilal Soylu 7/2010)
...
set PR_DESCRIPTION=Railo Tomcat 6 Server http://www.getRailo.org
...
"%EXECUTABLE%" //US//%SERVICE_NAME% ++JvmOptions "-Djava.io.tmpdir=%CATALINA_BASE%\temp;-Djava.util.logging.manager=org.apache.juli.ClassLoaderLogManager;-Djava.util.logging.config.file=%CATALINA_BASE%\conf\logging.properties" --JvmMs 128 --JvmMx 512
