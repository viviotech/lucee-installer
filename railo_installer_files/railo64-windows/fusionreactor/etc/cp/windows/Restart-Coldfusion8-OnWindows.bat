...
REM FusionReactor to automatically restart a monitored ColdFusion 8 server running on a Windows
REM machine.
REM
...
REM -------------------------------------------------------------------------------------------
set LOGFILE=C:\FusionReactor\etc\cp\Restart-Coldfusion8-OnWindows.log
REM -------------------------------------------------------------------------------------------
...
set COMMAND=sc \\%HOST% start "ColdFusion 8 Application Server"
REM -------------------------------------------------------------------------------------------
