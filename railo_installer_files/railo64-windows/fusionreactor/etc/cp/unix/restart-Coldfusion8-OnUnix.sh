...
# FusionReactor to automatically restart a ColdFusion 8 server running on a remote Unix
# machine from Unix.
#
...
# -------------------------------------------------------------------------------------------
LOGFILE=/opt/fusionreactor/etc/cp/restart-Coldfusion8-OnUnix.log
# -------------------------------------------------------------------------------------------
...
# -------------------------------------------------------------------------------------------
COMMAND="/opt/coldfusion8/bin/coldfusion start"
# -------------------------------------------------------------------------------------------
