...
rem purpose: to programmatically set the Railo service to start automatically
rem ---------------------------------------------------------------------------
...
:setService
rem set the tomcat/railo service to start automatically
set EXECUTABLE=%CATALINA_HOME%\bin\%SERVICE_FILE%
set SERVICE_NAME=OpenBD
