...
rem commenting out JAVA_HOME because we want the service to use JRE_HOME
...
"%EXECUTABLE%" //IS//%SERVICE_NAME% ^
    --Description "Lucee Tomcat 8 Server http://lucee.org" ^
