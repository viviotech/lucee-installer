...
# FusionReactor to automatically restart a ColdFusion MX server running on a remote Unix
# machine from Unix.
#
...
# -------------------------------------------------------------------------------------------
LOGFILE=/opt/fusionreactor/etc/cp/restart-Coldfusion6-OnUnix.log
# -------------------------------------------------------------------------------------------
...
# -------------------------------------------------------------------------------------------
COMMAND="/opt/coldfusionmx/bin/coldfusion start"
# -------------------------------------------------------------------------------------------
