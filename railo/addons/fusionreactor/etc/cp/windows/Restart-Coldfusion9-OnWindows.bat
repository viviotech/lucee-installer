...
REM FusionReactor to automatically restart a monitored ColdFusion 9 server running on a Windows
REM machine.
REM
...
REM -------------------------------------------------------------------------------------------
set LOGFILE=C:\FusionReactor\etc\cp\Restart-Coldfusion9-OnWindows.log
REM -------------------------------------------------------------------------------------------
...
set COMMAND=sc \\%HOST% start "ColdFusion 9 Application Server"
REM -------------------------------------------------------------------------------------------
