...
REM FusionReactor to automatically restart a monitored ColdFusion MX 6 server running on a
REM Windows machine.
REM
...
REM -------------------------------------------------------------------------------------------
set LOGFILE=C:\FusionReactor\etc\cp\Restart-Coldfusion6-OnWindows.log
REM -------------------------------------------------------------------------------------------
...
set COMMAND=sc \\%HOST% start "ColdFusion MX Application Server"
REM -------------------------------------------------------------------------------------------
